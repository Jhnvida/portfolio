                ...
                <div className="flex flex-col gap-6 max-w-2xl">
                    <h1 className="text-3xl sm:text-4xl md:text-5xl font-medium tracking-tight text-neutral-100 leading-[1.15]">
                        <span className="block overflow-hidden pb-1">
                            <span data-hero-mask-line className="block">Construo interfaces digitais</span>
                        </span>
                        <span className="block overflow-hidden pb-1">
                            <span data-hero-mask-line className="block">com rigor visual, código limpo</span>
                        </span>
                        <span className="block overflow-hidden pb-1">
                            <span data-hero-mask-line className="block">e atenção obsessiva aos detalhes.</span>
                        </span>
                    </h1>
